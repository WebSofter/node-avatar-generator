...
const { hashCode, getUnit, getDigit, getBoolean, getRandomColor } = require('../utils')

const ELEMENTS = conf.bauhaus.ELEMENTS
const SIZE = conf.bauhaus.SIZE
